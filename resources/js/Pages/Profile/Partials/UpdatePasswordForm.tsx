...
export default function UpdatePasswordForm({ className = '' }: { className?: string }) {
    ...
    return (
        <section className={className}>
            <header>
                <h2 className="text-lg font-medium text-gray-900 dark:text-gray-100">Atualizar a senha</h2>
            ...
            <form onSubmit={updatePassword} className="mt-6 space-y-6">
                ...
                <div>
                    <InputLabel htmlFor="password_confirmation" value="Confirmação de senha" />
