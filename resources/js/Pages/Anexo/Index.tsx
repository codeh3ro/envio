...
export default function EnvioProducaoMedica({ prestadores, count, classes, old } : Props) {
  ...
  const handleSendEmail = (massSend = false, onlySelected = false) => {  
    ...
    if (massSend) {
      ...
      post(route('envioAnexo.sendAnexoMail', { queryParams: paramsData , massSend: true }),{
        onSuccess: () => {
      ...
      post(route('envioAnexo.sendAnexoMail', { users: userData }),{
        onSuccess: () => {
          setSelectAllChecked(false);
          setSelectedPrestadores([]);
  ...
  const submit: FormEventHandler = (e) => {
    ...
    get(route('envioAnexo.searchAll'), {
      onSuccess: ({ props }) => {
  ...
  return (
        <AuthenticatedLayout
            header={<h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">Envio de Anexo</h2>}
        >
                                ...
                                <div className="grid gap-4 py-4">
                                  ...
                                  <Button onClick={() => {
                                    ...
                                    const userData = {
                                      ...
                                      post(route('envioAnexo.sendMail', { users: [ userData ] }),{
                                        onSuccess: () => {
                                          setSelectedPrestadores([]);
                                          setSelectAllChecked(false);
                                          toast.success('E-mail enviado com sucesso!', {
