        ...
        <div className="min-h-screen bg-gray-100 dark:bg-gray-900">
                        ...
                        <div className="flex">
                            ...
                            <div className="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                ...
                                <NavigationMenuList>
                                  <NavigationMenuItem>
                                    <NavigationMenuTrigger
                                      className={`ml-3 dark:bg-[#1f2937] ${!route().current('envioProducaoMedica.index') ? 'text-[#9ca3af]' : ''}`}
                                    >
                                      Relatórios
                                    </NavigationMenuTrigger>
                                    <NavigationMenuContent>
                                      <ul className="p-2 md:w-[140px] lg:w-[145px] dark:bg-[#111827]">
                                        <li className="p-2 rounded-sm hover:bg-gray-100 dark:hover:bg-[#111827]">
                                          <NavigationMenuLink asChild>
                                            <a
                                              className="flex flex-col text-sm"
                                              href={route('envioProducaoMedica.index')}
                                            >
                                              Produção Médica
                                            </a>
                                          </NavigationMenuLink>
            ...
            {header && (
                <header className="bg-white dark:bg-gray-800 shadow">
                    <div className="max-w-full ml-5 mx-auto py-6 px-4 sm:px-6 lg:px-8">{header}</div>
                </header>
            )}
