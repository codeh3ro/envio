...
use App\Legacy\Cardio\ClassePrestador;
use App\Legacy\Cardio\ContratoFinanceiro;
use App\Legacy\Cardio\DocFinanceiro;
use App\Legacy\Cardio\EspecPrestador;
use App\Legacy\Cardio\PrestadorServico;
use App\Legacy\Cardio\RegistroPessoa;
...
class JobCreatePdfProducaoMedica implements ShouldQueue
{
    ...
    public function generatePdfProducao(): string
    {
      try {
        $layout = 1;
        $contratoFinanceiro = $this->contratoFinanceiro;
        $autoId = $this->autoId;
        $autor = env('APP_NAME');
        $compFinanceira = $this->competencia;
    ...
    public function generatePdfExtratoImposto(): string
    {
      try {
        ...
        $docFinanceiro = new DocFinanceiro();
        $docFinanceiro->setContratoFinanceiro($this->contrato); //317700001818
        $docFinanceiro->setCompFinanceira($this->competencia); //202408
